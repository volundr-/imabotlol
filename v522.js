(function(self, $) {
    ...
    function onDocumentMouseScroll(event) {
        imageWidth *= Math.pow(0.9, event.wheelDelta / -120 || (event.detail || 0));
        if (1 > imageWidth) {
            /** @type {number} */
            imageWidth = 1;
        }
        if (imageWidth > 2 / ratio) {
            /** @type {number} */
            imageWidth = 2 / ratio;
        }
    }
    ...
    function triggerObjectAt() {
        newValue = (mx - width / 2) / ratio + x;
        last = (y - height / 2) / ratio + r;
    }
    /**
     * @return {undefined}
     */
    ...
    function parse(n) {
        ...
        switch(d.getUint8(0)) {
            ...
            case 17:
                /** @type {number} */
                dw = d.getFloat32(1, true);
                /** @type {number} */
                v = d.getFloat32(5, true);
                /** @type {number} */
                newRatio = d.getFloat32(9, true);
                break;
            case 20:
                /** @type {Array} */
                data = [];
        ...
        if (queue()) {
            ...
            if (!(64 > z0 * z0 + z1 * z1)) {
                if (!(value == newValue && i == last)) {
                    ...
                    z1 = new DataView(z0);
                    z1.setUint8(0, 16);
                    z1.setFloat64(1, newValue, true);
                    z1.setFloat64(9, last, true);
    ...
    function build() {
        if (0 != data.length) {
            ...
            /** @type {number} */
            offset = Math.pow(Math.min(64 / offset, 1), 0.4);
            offset *= Math.max(height / 1080, width / 1920);
            offset *= imageWidth;
            /** @type {number} */
    ...
    function draw() {
        ...
        if (0 < data.length) {
            ...
            r = (29 * r + v) / 30;
            /** @type {number} */
            ratio = (9 * ratio + newRatio * imageWidth) / 10;
        }
        processData();
        triggerObjectAt();
        ...
        if (0 != closingAnimationTime) {
            ...
            /** @type {number} */
            ctx.globalAlpha = 1;
            ctx.drawImage(t, 15, height - 10 - 24 - 5);
        }
        clear();
        /** @type {number} */
        tick = +new Date - tick;
            ...
            if ("undefined" == typeof console || ("undefined" == typeof DataView || ("undefined" == typeof WebSocket || (null == elem || (null == elem.getContext || null == self.localStorage))))) {
                ...
                move.prototype = {
                    ...
                    shouldRender : function() {
                        return this.x + this.size + 40 < x - width / 2 / ratio || (this.y + this.size + 40 < r - height / 2 / ratio || (this.x - this.size - 40 > x + width / 2 / ratio || this.y - this.size - 40 > r + height / 2 / ratio)) ? false : true;
                    },
                    /**
                     * @return {undefined}
                     */
                    draw : function() {
                        if (this.shouldRender()) {
                            /** @type {boolean} */
                            var y_position = !this.isVirus && (!this.isAgitated && 0.35 > ratio);
                            ...
                            if (!this.isAgitated && (result && "" == dest)) {
                            ...
                            /** @type {number} */
                            y_position = ~~this.y;
                            if ((text || c) && (this.name && (this.nameCache && (null == el || -1 == reserved.indexOf(i))))) {
                                el = this.nameCache;
